    ...
    <div className="h-screen bg-base-100 flex flex-col">
      ...
      <div className="flex-1">
        <PanelGroup direction="horizontal">
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    {problemData?.constraints &&
                      problemData.constraints.length > 0 && (
                        <div className="bg-base-100 rounded-xl shadow-sm p05 border border-base-300">
                          <h2 className="text-xl font-bold mb-4 text-base-content">
                            Constraints
                          </h2>
                          <ul className="space-y-2 text-base-content/90">
                            {problemData.constraints.map((constraint, idx) => (
                              <li key={idx} className="flex gap-2">
                                <span className="text-primmary">•</span>
          ...
          <PanelResizeHandle className="w-2 bg-base-300 hover:bg-primary transitionn-colors cursor-col-resize" />
          <Panel defaultSize={50} minSize={30}>
